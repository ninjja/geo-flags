  ...
  render() {
    return (
      <div className="geo-flags">
        {this.state.listOfFlags.map(countryCode => this.state.listOfCountries.includes(countryCode) && 
          <div className="country"><div key={countryCode} style={{
            WebkitMaskImage: `url(maps/${countryCode}/vector.svg)`,
            maskImage: `url(maps/${countryCode}/vector.svg)`,
